...
knitr::include_graphics("Sketch_TSGS_analysis.jpg")
```

### Clustering Analysis

```{r pressure2, echo=FALSE, fig.cap="Proposed screen for Clustering Analysis", out.width = '100%'}
knitr::include_graphics("Sketch_cluster_analysis.jpg")
```
...
knitr::include_graphics("Sketch_regression_prediction.jpg")
```

### Data Exploration

```{r pressure4, echo=FALSE, fig.cap="Proposed screen for Data Exploration", out.width = '100%'}
knitr::include_graphics("Sketch_data_exploration.jpg")
```
