...
There are very few multivariate analysis done, and of those conducted, most of them are presented in tabular form or described in text. Only one study on regression models presented its findings visually in a scatterplot with fit lines (Figure 5).

![*(Top)* Table showing the regression models summaries and parameter estimates to predict new COVID-19 deaths. *(Bottom)* Scatterplot with fit lines comparing the regression models built to predict new COVID-19 deaths by day @argawu2020.](images/deaths-currMLR.jpg)
...
Likert scales are most commonly presented in pie charts and variations of the bar chart. Salient points regarding each chart type (Figure 6) are highlighted:- 
...
![Grouped bar chart representing responses to a Likert scale survey](images/survey-likert.jpg)
