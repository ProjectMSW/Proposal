...
Closer examination would be needed to understand the factors that could be affecting different countries’ inclination towards vaccination, which would provide useful insights on possible strategies to improve vaccination rates, such as vaccination awareness campaigns.
